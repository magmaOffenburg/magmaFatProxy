...
import magma.agent.model.thoughtmodel.strategy.impl.roles.PenaltyDefender;
...
public class PenaltyDefenderStrategy extends BaseStrategy
{
	public static final String NAME = "PenaltyDefenderStrategy";

	public PenaltyDefenderStrategy(IRoboCupThoughtModel thoughtModel)
	{
		...
		Role penaltyDefender = new PenaltyDefender("PenaltyDefender", worldModel, 5.0f);
		...
		availableRoles.add(new ManToManMarker(penaltyDefender, FieldArea.UPPER));
